<? /* $Id: alterar.php,v 1.5 2002/07/16 17:41:57 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="tcv_nome" value="<?= in_html($dados["tcv_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="tcv_desc" value="<?= in_html($dados["tcv_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
