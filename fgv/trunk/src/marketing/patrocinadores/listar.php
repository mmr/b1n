...
<? $list_data = busca_patrocinador($sql, $busca); ?>
...
?>
          <tr>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["pat_nome"]) ?></td>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["pat_nome_contato"]) ?></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=consultar&id=<?= $item["pat_id"] ?>">Consultar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=alterar&id=<?= $item["pat_id"] ?>">Editar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=apagar&id=<?= $item["pat_id"] ?>">Excluir</a></td>
          </tr>
...
?>
<tr>
    <td COLSPAN="<?= $colspan ?>" bgColor="#ffffff" HEIGHT="17">
<?
