<? /* $Id: inserir.php,v 1.2 2002/07/16 17:44:13 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="tev_nome" value="<?= in_html($dados["tev_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="tev_desc" value="<?= in_html($dados["tev_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
