<? /* $Id: alterar.php,v 1.5 2002/07/16 17:44:13 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="cat_nome" value="<?= in_html($dados["cat_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="cat_desc" value="<?= in_html($dados["cat_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
