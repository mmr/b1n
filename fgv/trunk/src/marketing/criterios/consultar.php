<? /* $Id: consultar.php,v 1.3 2002/04/17 19:03:49 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["cri_nome"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Peso</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["cri_peso"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb">Descrição</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["cri_desc"]) ?></td>
            </tr>
            <tr>
