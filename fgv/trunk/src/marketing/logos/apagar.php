<? /* $Id: apagar.php,v 1.3 2002/04/17 19:03:51 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff' class='text'>&nbsp;<?= in_html($dados["lgo_nome"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff' class='text'>&nbsp;<?= in_html($dados["lgo_desc"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb">Arquivo para Upload</td>
              <td bgcolor='#ffffff' class="text">&nbsp;<?= $dados["lgo_nome_falso"] ?></td>
            </tr>
            <tr>
