<? /* $Id: inserir.php,v 1.4 2002/07/16 17:47:43 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="tpj_nome" value="<?= in_html($dados["tpj_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="tpj_desc" value="<?= in_html($dados["tpj_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
