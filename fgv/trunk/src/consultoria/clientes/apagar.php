<? /* $Id: apagar.php,v 1.7 2002/07/12 18:08:35 binary Exp $ */ ?>
    ...
    <tr>
      <td>
        <table border="0" cellspacing="1" cellpadding="5" width="100%" class="text">
            ...
            <tr>
              <td bgcolor='#ffffff' class="textb">Endereço</td>
              <td bgcolor='#ffffff'><?= ( ( $dados["cli_cob_endereco"]) == '' ? in_html( $dados["cli_endereco"] ) : in_html( $dados["cli_cob_endereco"] ) ) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb">CEP</td>
              <td bgcolor='#ffffff'><?= ( ( $dados["cli_cob_cep"]) == '' ? in_html( $dados["cli_cep"] ) : in_html( $dados["cli_cob_cep"] ) ) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Telefone</td>
              <td bgcolor='#ffffff'>&nbsp;
