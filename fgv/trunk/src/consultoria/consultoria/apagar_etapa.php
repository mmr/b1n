<? /* $Id: apagar_etapa.php,v 1.1 2002/04/26 16:00:37 binary Exp $ */ ?>
    ...
    <tr>
      <td>
          <form method="post" action="<?= $_SERVER["SCRIPT_NAME"] ?>" enctype="multipart/form-data">
            ...
            <input type="hidden" name="etp_id"      value="<?= $dados["etp_id"] ?>" />
        ...
        <table border="0" cellspacing="1" cellpadding="5" width="100%" class="text">
            <tr>
              <td class="textwhitemini" colspan="<?= $colspan ?>" bgcolor="#336699" height="17">
                <img src="images/icone.gif" width="23" height="17" align="absbottom" />&nbsp;&nbsp;<?= $mod_titulo . " - Apagar Etapa" ?>
              </td>
            </tr>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["etp_ordem"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Etapa</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["etp_desc"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Data de Início</td>
              <td bgcolor='#ffffff'>&nbsp;<?= implode("/", $dados["etp_dt_ini"]); ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Data de Fim (dias úteis)</td>
              <td bgcolor='#ffffff'><?= in_html($dados["etp_dt_fim_u"]) ?> dias úteis</td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Data de Início</td>
              <td bgcolor='#ffffff'>&nbsp;<?= implode("/", $dados["etp_dt_fim"]); ?></td>
            </tr>
            <tr>
