<? /* $Id: contrato.php,v 1.1 2002/04/26 16:00:37 binary Exp $ */ ?>
<br />
<br />
<center>
...
<form method="post" action="<?= $_SERVER["SCRIPT_NAME"] ?>" enctype="multipart/form-data">
    ...
    <input type="hidden" name="status"      value="<?= CST_CONTRATO_EM_ANDAMENTO ?>" />
    <input type="hidden" name="cst_status"  value="<?= CST_CONTRATO_EM_ANDAMENTO ?>" />
        ...
        <table border="0" cellspacing="1" cellpadding="5" width="100%" class="text">
            <tr>
              <td class="textwhitemini" colspan="<?= $colspan ?>" bgcolor="#336699" height="17">
                <img src="images/icone.gif" width="23" height="17" align="absbottom" />&nbsp;&nbsp;<?= $mod_titulo ?> - Gerar Contrato
              </td>
            </tr>
