<? /* $Id: alterar_atividade.php,v 1.1 2002/04/26 16:00:37 binary Exp $ */ ?>
        ...
        <table border="0" cellspacing="1" cellpadding="5" width="100%" class="text">
            <tr>
              <td class="textwhitemini" colspan="<?= $colspan ?>" bgcolor="#336699" height="17">
                <img src="images/icone.gif" width="23" height="17" align="absbottom" />&nbsp;&nbsp;<?= $mod_titulo ?> - Alterar Atividade
              </td>
            </tr>
...
<? } ?>
            ...
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="atv_dt_fim_u" value="<?= in_html($dados["atv_dt_fim_u"]) ?>" size="3" /> Dias úteis</td>
            </tr>
            <tr>
