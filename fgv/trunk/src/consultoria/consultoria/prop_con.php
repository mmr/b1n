        ...
        <table border="0" cellspacing="1" cellpadding="5" width="100%" class="text">
            <tr>
              <td class="textwhitemini" colspan="<?= $colspan ?>" bgcolor="#336699" height="17">
                <img src="images/icone.gif" width="23" height="17" align="absbottom" />&nbsp;&nbsp;<?= $mod_titulo ?> - Proposta Concluída
              </td>
            </tr>
...
<? } ?>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Data Reunião de Apresentação da Proposta</td> 
              <td bgcolor='#ffffff'>&nbsp;<? gera_select_data("cst_dt_prp_reuniao", $dados["cst_dt_prp_reuniao"]); ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb">Local Reunião</td>
