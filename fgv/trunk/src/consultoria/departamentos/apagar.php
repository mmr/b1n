<? /* $Id: apagar.php,v 1.1 2002/08/05 13:30:21 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["dpt_nome"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["dpt_desc"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Andar</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["dpt_andar"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Ramal</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["dpt_ramal"]) ?></td>
            </tr>
            <tr>
