<? /* $Id: alterar.php,v 1.1 2002/08/05 13:30:21 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="dpt_nome" value="<?= in_html($dados["dpt_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="dpt_desc" value="<?= in_html($dados["dpt_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Andar</td>
              <td bgcolor='#ffffff'><input type="text" name="dpt_andar" value="<?= in_html($dados["dpt_andar"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Ramal</td>
              <td bgcolor='#ffffff'><input type="text" name="dpt_ramal" value="<?= in_html($dados["dpt_ramal"]) ?>" size="30" /></td>
            </tr>
            <tr>
