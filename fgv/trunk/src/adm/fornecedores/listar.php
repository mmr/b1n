...
$list_data = busca_fornecedor($sql, $busca);
...
?>
          <tr>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["for_nome"]) ?></td>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["for_nome_contato"]) ?></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=consultar&id=<?= $item["for_id"] ?>">Consultar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=alterar&id=<?= $item["for_id"] ?>">Editar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=apagar&id=<?= $item["for_id"] ?>">Excluir</a></td>
          </tr>
...
?>
<tr>
    <td class="textwhitemini" COLSPAN="<?= $colspan ?>" bgColor="#ffffff" HEIGHT="17">
<?
