<? /* $Id: consultar.php,v 1.6 2002/07/12 16:06:04 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["for_nome"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Nome do Contato</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["for_nome_contato"]) ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td bgcolor='#ffffff'>&nbsp;
                <?= in_html(
                    ( consis_telefone( $dados[ "for_ddi" ] ) ? " (+" . $dados[ "for_ddi" ] . ")" : "" ) .
                    ( consis_telefone( $dados[ "for_ddd" ] ) ? " ("  . $dados[ "for_ddd" ] . ")" : "" ) .
                    $dados[ "for_telefone" ] )
                ?>
              </td>
            </tr>
            <tr>
              ...
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["for_ramal"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Fax</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["for_fax"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Celular</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["for_celular"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Email</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["for_email"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>HomePage</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["for_homepage"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Comentários</td>
              <td bgcolor='#ffffff'><textarea name="for_texto" cols="65" rows="15" disabled><?= htmlspecialchars($dados["for_texto"]) ?></textarea></td>
            </tr>
            <tr>
