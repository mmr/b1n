<? /* $Id: inserir.php,v 1.1 2002/07/30 13:41:47 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="fgv_nome" value="<?= in_html($dados["fgv_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Função</td>
              <td bgcolor='#ffffff'><input type="text" name="fgv_funcao" value="<?= in_html($dados["fgv_funcao"]) ?>" size="30" /></td>
            </tr>
            <tr>
