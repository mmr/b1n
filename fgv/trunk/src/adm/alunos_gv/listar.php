<?
/* $Id: listar.php,v 1.6 2002/07/31 21:18:13 binary Exp $ */

$list_data = busca_aluno_gv($sql, $busca);
        ...
        <table border='0' cellspacing='1' cellpadding='5' width='100%' class='text'>
          <tr>
            <td class="textwhitemini" colspan="3" bgcolor="#336699" height="17">
              <img src="images/icone.gif" width="23" height="17" align="absbottom">&nbsp;&nbsp;Alunos GV - Busca
            </td>
          </tr>
          <tr>
...
{
    /* quantidade de colunas a mostras dividido por 2 + 3 das funcoes - 1 da coluna de id que nao eh mostrada */
    $colspan = sizeof($list_data["result"][0])/2 + 3 - 1;
?>
  <table border="0" cellspacing="0" cellpadding="0" bgcolor="#000000" width="630">
    <tr>
      <td>
        <table border="0" cellspacing="1" cellpadding="5" width="100%" class="text">
          <tr>
            <td class="textwhitemini" COLSPAN="<?= $colspan ?>" bgColor="#336699" HEIGHT="17">
              <img src="images/icone.gif" width="23" height="17" align="absbottom">&nbsp;&nbsp;Alunos GV
            </td>
          </tr>
<?
...
?>
          <tr>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["agv_matricula"]) ?></td>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["agv_nome"]) ?></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=consultar&id=<?= $item["agv_id"] ?>">Consultar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=alterar&id=<?= $item["agv_id"] ?>">Editar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=apagar&id=<?= $item["agv_id"] ?>">Excluir</a></td>
          </tr>
...
?>
<tr>
    <td class="textwhitemini" COLSPAN="<?= sizeof($list_data["result"][0])/2 + 3 - 1 ?>" bgColor="#ffffff" HEIGHT="17">
<?
