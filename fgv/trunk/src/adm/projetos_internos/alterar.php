<? /* $Id: alterar.php,v 1.2 2002/04/29 14:54:57 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="pin_nome" value="<?= in_html($dados["pin_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb">Descrição</td>
              <td bgcolor='#ffffff'><textarea name="pin_desc" cols="65" rows="15"><?= in_html($dados["pin_desc"]) ?></textarea></td>
            </tr>
            <tr>
