<? /* $Id: consultar.php,v 1.3 2002/04/29 14:54:57 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["pin_nome"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb">Descrição</td>
              <td bgcolor='#ffffff'><textarea name="pin_desc" cols="65" rows="15" disabled><?= in_html($dados["pin_desc"]) ?></textarea></td>
            </tr>
            <tr>
