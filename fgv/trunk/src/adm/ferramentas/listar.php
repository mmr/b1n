...
$list_data = busca_ferramenta($sql, $busca);
...
?>
          <tr>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["frm_nome"]) ?></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=consultar&id=<?= $item["frm_id"] ?>">Consultar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=alterar&id=<?= $item["frm_id"] ?>">Editar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=apagar&id=<?= $item["frm_id"] ?>">Excluir</a></td>
          </tr>
