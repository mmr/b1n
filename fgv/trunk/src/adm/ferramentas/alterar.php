<? /* $Id: alterar.php,v 1.4 2002/04/30 20:07:28 binary Exp $ */ ?>
...
<? } ?>
            ...
            <?
            if( $dados[ "frm_arq_falso" ] != "" )
                    print "Arquivo Atual:  <a href='" . $_SERVER[ 'SCRIPT_NAME' ] . "?suppagina=download&id=" . $dados[ 'id' ] . "&tabela=ferramenta&col_id=frm_id&arq_col_r=frm_arq_real&arq_col_f=frm_arq_falso '>" . $dados[ 'frm_arq_falso' ] . "</a><br />";
            ?>
