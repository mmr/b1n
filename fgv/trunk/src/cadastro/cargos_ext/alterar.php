...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="cex_nome" value="<?= in_html($dados["cex_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="cex_desc" value="<?= in_html($dados["cex_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
