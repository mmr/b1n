<? /* $Id: alterar.php,v 1.1 2002/07/30 13:06:54 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="tse_nome" value="<?= in_html($dados["tse_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb">Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="tse_desc" value="<?= in_html($dados["tse_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb">Tipo</td>
              <td bgcolor='#ffffff'>
                <select name='tse_tipo'>
                  <option value='s'<? if ($dados["tse_tipo"] == "s") print " selected"; ?>>Serviço</option>
                  <option value='p'<? if ($dados["tse_tipo"] == "p") print " selected"; ?>>Produto</option>
                </select>
            </tr>
            <tr>
