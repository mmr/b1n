<? /* $Id: apagar.php,v 1.1 2002/07/30 13:06:54 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["tse_nome"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb">Descrição</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["tse_desc"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb">Tipo</td>
              <td bgcolor='#ffffff'><?= ($dados["tse_tipo"] == "s") ? "Serviço" : "Produto" ?></td>
            </tr>
            <tr>
