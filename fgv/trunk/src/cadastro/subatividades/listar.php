...
$list_data = busca_ts_subatividade($sql, $busca);
?>
...
?>
          <tr>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["tsa_nome"]) ?></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=consultar&id=<?= $item["tsa_id"] ?>">Consultar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=alterar&id=<?= $item["tsa_id"] ?>">Editar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=apagar&id=<?= $item["tsa_id"] ?>">Excluir</a></td>
          </tr>
