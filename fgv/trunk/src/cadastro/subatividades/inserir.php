...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="tsa_nome" value="<?= in_html($dados["tsa_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="tsa_desc" value="<?= in_html($dados["tsa_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
