<? /* $Id: alterar.php,v 1.6 2002/07/16 17:47:42 binary Exp $ */ ?>
          ...
          <form method="post" action="<?= $_SERVER["SCRIPT_NAME"] ?>">
            ...
            <tr>
              <td class="textwhitemini" colspan="<?= $colspan ?>" bgcolor="#336699" height="17">
                <img src="images/icone.gif" width="23" height="17" align="absbottom">&nbsp;&nbsp;Status de evento (tarefa do cronograma) - Alterar
              </td>
            </tr>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="ste_nome" value="<?= in_html($dados["ste_nome"]) ?>" size="30" ></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="ste_desc" value="<?= in_html($dados["ste_desc"]) ?>" size="30" ></td>
            </tr>
            <tr>
