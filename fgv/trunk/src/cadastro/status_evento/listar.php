...
<? $list_data = busca_status_evento($sql, $busca); ?>
        ...
        <table border='0' cellspacing='1' cellpadding='5' width='100%' class='text'>
          <tr>
            <td class="textwhitemini" colspan="3" bgcolor="#336699" height="17">
                <img src="images/icone.gif" width="23" height="17" align="absbottom">&nbsp;&nbsp;Status de evento (tarefa do cronograma) - Busca
            </td>
          </tr>
          <tr>
        ...
        <table border="0" cellspacing="1" cellpadding="5" width="100%" class="text">
          <tr>
            <td class="textwhitemini" COLSPAN="4" bgColor="#336699" HEIGHT="17">
              <img src="images/icone.gif" width="23" height="17" align="absbottom">&nbsp;&nbsp;Status de evento
            </td>
          </tr>
<?
...
?>
          <tr>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["ste_nome"]) ?></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=consultar&id=<?= $item["ste_id"] ?>">Consultar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=alterar&id=<?= $item["ste_id"] ?>">Editar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=apagar&id=<?= $item["ste_id"] ?>">Excluir</a></td>
          </tr>
