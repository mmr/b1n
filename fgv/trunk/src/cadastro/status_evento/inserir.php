<? /* $Id: inserir.php,v 1.6 2002/07/16 17:47:42 binary Exp $ */ ?>
          ...
          <form method="post" action="<?= $_SERVER["SCRIPT_NAME"] ?>">
            ...
            <tr>
              <td class="textwhitemini" colspan="<?= $colspan ?>" bgcolor="#336699" height="17">
                <img src="images/icone.gif" width="23" height="17" align="absbottom">&nbsp;&nbsp;Status de evento (tarefa do cronograma) - Inserir
              </td>
            </tr>
