<? /* $Id: alterar.php,v 1.1 2002/07/30 13:28:46 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="cgv_nome" value="<?= in_html($dados["cgv_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="cgv_desc" value="<?= in_html($dados["cgv_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
