<? /* $Id: alterar.php,v 1.1 2002/07/30 13:34:33 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="cla_nome" value="<?= in_html($dados["cla_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="cla_desc" value="<?= in_html($dados["cla_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
