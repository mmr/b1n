<? /* $Id: alterar.php,v 1.1 2002/07/30 13:34:34 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="set_nome" value="<?= in_html($dados["set_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="set_desc" value="<?= in_html($dados["set_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
