<? /* $Id: consultar.php,v 1.1 2002/07/30 13:34:34 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              <td bgcolor='#ffffff' class="textb" class='textb'>Nome</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["reg_nome"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class="textb" class='textb'>Descrição</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["reg_desc"]) ?></td>
            </tr>
            <tr>
