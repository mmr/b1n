...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="reg_nome" value="<?= in_html($dados["reg_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="reg_desc" value="<?= in_html($dados["reg_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
