<? /* $Id: listar.php,v 1.3 2002/07/31 21:10:47 binary Exp $ */ ?>

<? $list_data = busca_plano_pgto($sql, $busca); ?>
...
?>
          <tr>
            ...
            <td bgcolor='#ffffff' class="textb">Parcelas</td>
...
?>
          <tr>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["ppg_nome"]) ?></td>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html($item["ppg_plano"]) ?></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=consultar&id=<?= $item["ppg_id"] ?>">Consultar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=alterar&id=<?= $item["ppg_id"] ?>">Editar</a></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=apagar&id=<?= $item["ppg_id"] ?>">Excluir</a></td>
          </tr>
<?
    }
