<? /* $Id: inserir.php,v 1.1 2002/07/30 13:07:39 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="ppg_nome" value="<?= in_html($dados["ppg_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="ppg_desc" value="<?= in_html($dados["ppg_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Parcelas</td>
              <td bgcolor='#ffffff'><input type="text" name="ppg_plano" value="<?= in_html($dados["ppg_plano"]) ?>" size="3" /></td>
            </tr>
            <tr>
