...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="are_nome" value="<?= in_html($dados["are_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="are_desc" value="<?= in_html($dados["are_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
