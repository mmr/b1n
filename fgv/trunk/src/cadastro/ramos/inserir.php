...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="ram_nome" value="<?= in_html($dados["ram_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="ram_desc" value="<?= in_html($dados["ram_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
