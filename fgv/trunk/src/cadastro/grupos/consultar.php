<? /* $Id: consultar.php,v 1.1 2002/07/30 13:28:46 binary Exp $ */ ?>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff' class="text" colspan="3">&nbsp;<?= in_html($dados["grp_nome"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff' class="text" colspan="3">&nbsp;<?= in_html($dados["grp_desc"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Membros</td>
              <td bgcolor='#ffffff' class="text">
                <?= gera_select_g($sql, "mem_id", "mem_nome", "membro_vivo", $dados["grp_membros"], array("name" => "grp_membros[]", "multiple" => "", "size" => 10, "disabled" => ""),1) ?></td>
              </td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Funções</td>
              <td bgcolor='#ffffff' class="text">
                <?= gera_select_g($sql, "fnc_id", "fnc_nome", "funcao", $dados["grp_funcoes"], array("name" => "grp_funcoes[]", "multiple" => "", "size" => 10, "disabled" => ""),1) ?>
              </td>
            </tr>
            <tr>
