          ...
          <form method="post" action="<?= $_SERVER["SCRIPT_NAME"] ?>">
            ...
            <tr>
              <td class="textwhitemini" colspan="<?= $colspan ?>" bgcolor="#336699" height="17">
                <img src="images/icone.gif" width="23" height="17" align="absbottom">&nbsp;&nbsp;Status de contato - Apagar
              </td>
            </tr>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["stc_nome"]) ?></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'>&nbsp;<?= in_html($dados["stc_desc"]) ?></td>
            </tr>
            <tr>
