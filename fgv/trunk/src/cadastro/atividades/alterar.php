...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff' class="text" colspan="3"><input type="text" name="tat_nome" value="<?= in_html($dados["tat_nome"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff' class="text" colspan="3"><input type="text" name="tat_desc" value="<?= in_html($dados["tat_desc"]) ?>" size="30" /></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>SubAtividades</td>
              <td bgcolor='#ffffff' class="text">
                <?= gera_select_g($sql, "tsa_id", "tsa_nome", "ts_subatividade", $dados["ts_subatividades"], array("name" => "ts_subatividades[]", "multiple" => "", "size" => 10),1) ?></td>
              </td>
            </tr>
            <tr>
