          ...
          <form method="post" action="<?= $_SERVER["SCRIPT_NAME"] ?>">
            ...
            <tr>
              <td class="textwhitemini" colspan="<?= $colspan ?>" bgcolor="#336699" height="17">
                <img src="images/icone.gif" width="23" height="17" align="absbottom">&nbsp;&nbsp;Tipos de email - Alterar
              </td>
            </tr>
...
<? } ?>
            <tr>
              ...
              <td bgcolor='#ffffff'><input type="text" name="ttk_nome" value="<?= in_html($dados["ttk_nome"]) ?>" size="30" ></td>
            </tr>
            <tr>
              <td bgcolor='#ffffff' class='textb'>Descrição</td>
              <td bgcolor='#ffffff'><input type="text" name="ttk_desc" value="<?= in_html($dados["ttk_desc"]) ?>" size="30" ></td>
            </tr>
            <tr>
