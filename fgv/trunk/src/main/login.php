<? /* $Id: login.php,v 1.12 2004/01/20 21:13:02 mmr Exp $ */ ?>

<center>
<br/>
<br/>
  <form name="formulario" method="post" action="<?= $_SERVER["SCRIPT_NAME"] ?>">
...
<? } ?>
    ...
    </table><BR><BR><div align="right"><IMG SRC="images/tecnologia.gif"  HSPACE="5"></div>
  </form>
</center>
<!--fim conteudo -->
