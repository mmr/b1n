-- $Id: scvp.sql,v 1.1.1.1 2004/01/25 15:18:50 mmr Exp $
...
GO
DROP TABLE autor, palchave, artigo_idioma, artigo, fasciculo, secao
GO

  -- Site
DROP VIEW view_area, view_noticia, view_link
GO
DROP TABLE link, noticia, area
GO
DROP TABLE idioma
GO
...
(
  ...
  idi_padrao_pub  BIT NOT NULL  DEFAULT 0,
  idi_padrao_site BIT NOT NULL  DEFAULT 0,
  idi_site        BIT NOT NULL  DEFAULT 0,
...
CREATE TABLE secao
(
  idi_id   INT NOT NULL,  -- FK idioma (site)
...
CREATE TABLE artigo
(
  idi_id  INT NOT NULL, -- FK idioma (idioma dos arquivos pdf/html)
...
CREATE VIEW view_artigo AS
  ...
  FROM
    ...
    idioma        i   ON (i.idi_id  = ai.idi_id)  LEFT JOIN
    secao         s   ON (a.sec_id  = s.sec_id)
  WHERE
    ai.idi_id =
      (SELECT TOP 1 idi_id FROM idioma WHERE idi_padrao_site = '1')
GO
...
ALTER TABLE grp_fnc ADD FOREIGN KEY (fnc_id) REFERENCES funcao  (fnc_id) ON DELETE CASCADE ON UPDATE CASCADE
  ...
  -- Pub
ALTER TABLE secao ADD FOREIGN KEY (idi_id) REFERENCES idioma (idi_id) ON DELETE NO ACTION ON UPDATE NO ACTION
...
ALTER TABLE artigo ADD FOREIGN KEY (idi_id) REFERENCES idioma (idi_id)  ON DELETE NO ACTION ON UPDATE NO ACTION
...
ALTER TABLE artigo_idioma ADD FOREIGN KEY (idi_id) REFERENCES idioma (idi_id) ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE palchave ADD FOREIGN KEY (aid_id) REFERENCES artigo_idioma (aid_id) ON DELETE CASCADE ON UPDATE CASCADE

  -- Site
ALTER TABLE area ADD FOREIGN KEY (idi_id) REFERENCES idioma (idi_id) ON DELETE NO ACTION ON UPDATE NO ACTION

ALTER TABLE area ADD FOREIGN KEY (are_real_id) REFERENCES area (are_id) ON DELETE NO ACTION ON UPDATE NO ACTION

ALTER TABLE noticia ADD FOREIGN KEY (idi_id) REFERENCES idioma (idi_id) ON DELETE NO ACTION ON UPDATE NO ACTION

ALTER TABLE link ADD FOREIGN KEY (idi_id) REFERENCES idioma (idi_id) ON DELETE NO ACTION ON UPDATE NO ACTION
...
GO
  ...
  -- Pub
INSERT INTO funcao (fnc_nome) VALUES ('comum :: idioma :: adiciona')
INSERT INTO funcao (fnc_nome) VALUES ('comum :: idioma :: altera')
INSERT INTO funcao (fnc_nome) VALUES ('comum :: idioma :: ativa')
INSERT INTO funcao (fnc_nome) VALUES ('comum :: idioma :: exclui')
INSERT INTO funcao (fnc_nome) VALUES ('comum :: idioma :: visualiza')
INSERT INTO funcao (fnc_nome) VALUES ('comum :: idioma :: lista')
GO
...
-- Default Data
  -- Pub
INSERT INTO idioma (idi_nome, idi_nome_no_idioma, idi_padrao_site, idi_site) VALUES ('Português', 'Português', 1, 1)
INSERT INTO idioma (idi_nome, idi_nome_no_idioma, idi_padrao_pub,  idi_site) VALUES ('Inglês', 'English', 1, 1)
INSERT INTO idioma (idi_nome, idi_nome_no_idioma, idi_site) VALUES ('Espanhol', 'Español', 1)
GO
UPDATE idioma SET idi_ativo = 1
GO

  -- Site
    -- Areas Reais
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (1, 'Home', 'home', 1)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (1, 'Busca Simples', 'busca_simples', 2)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (1, 'Busca Avançada', 'busca_avancada', 3)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (1, 'Coleção Completa', 'browse', 4)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (1, 'Links', 'links', 5)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (1, 'Notícias', 'noticias', 6)

    -- Areas "falsas"
      -- Ingles
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (2, 'Home', 'home', 1)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (2, 'Simple Search', 'busca_simples', 2)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (2, 'Advanced Search', 'busca_avancada', 3)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (2, 'Browse', 'browse', 4)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (2, 'Links', 'links', 5)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (2, 'News', 'noticias', 6)

      -- Espanhol
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (3, 'Home', 'home', 1)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (3, 'Busca Simples', 'busca_simples', 2)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (3, 'Busca Avançada', 'busca_avancada', 3)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (3, 'Coleção Completa', 'browse', 4)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (3, 'Links', 'links', 5)
INSERT INTO area (idi_id, are_nome, are_codigo, are_ordem) VALUES (3, 'Notícias', 'noticias', 6)
GO
