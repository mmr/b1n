...
function editor_generate(objname,userConfig) {
  ...
  var tblOpen  = '<table border=0 cellspacing=0 cellpadding=0 style="width=0;float: left;"  unselectable="on"><tr><td style="background: none;border: none; padding: 1 0 0 0"><nobr>';
  ...
  var editor = '<span id="_editor_toolbar"><table border=0 cellspacing=0 cellpadding=0 bgcolor="buttonface" style="padding: 1 0 0 2" width=' + config.width + ' unselectable="on"><tr><td style="background: none">\n'
  + toolbar
  + '</td></tr></table>\n'
  + '</td></tr></table></span>\n'
...
function editor_cMenu_generate(editorWin,objname) {
  ...
  var cMenuHeader = ''
    ...
    + ' <tr><td colspan=2 height=1 style="background: none"></td></tr>';
  ...
  for (var menuIdx in editor_cMenu.options) {
    ...
    if (menuName == "---" || menuName == "separator") {
      cMenuList += ' <tr><td colspan=2 class="cMenuDivOuter" style="background: none"><div class="cMenuDivInner"></div></td></tr>';
    }
    ...
    // menu option
      ...
      if (menuKey) { cMenuList += ' <td align=left class="cMenu" style="background: none">' +menuName+ '</td><td align=right class="cMenu" style="background: none">' +menuKey+ '</td>'; }
      else         { cMenuList += ' <td colspan=2 class="cMenu" style="background: none">' +menuName+ '</td>'; }
      cMenuList += '</tr>';
    }
  }
