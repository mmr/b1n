...
$search = b1n_regSearchLink($sql, $search);
// Colspan = checkbox(1) + number(1) + select_fields(?) + functions(?)
$colspan = 1 + sizeof($search['select_fields']) + 3;
...
?>
        ...
        <tr>
          ...
          <td class='c'><a href="javascript:b1n_orderBy('lnk_nome');">Nome</a></td>
          <td class='c'><a href="javascript:b1n_orderBy('lnk_url');">URL</a></td>
          <td class='c'><a href="javascript:b1n_orderBy('lnk_ativo');">Ativo</a></td>
...
?>
        <tr>
          ...
          <td class='c'><?= $item['idi_nome'] ?></td>
          <td class='c'><?= $item['lnk_nome'] ?></td>
          <td class='c'><?= $item['lnk_url'] ?></td>
          <td class='c'><?= $item['lnk_ativo'] == 1?'Sim':'Não' ?></td>
<?
      if(empty($item['lnk_real_id']))
      {
        echo "<td class='c'>&nbsp;";
