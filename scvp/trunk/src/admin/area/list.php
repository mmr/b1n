...
$search = b1n_regSearchArea($sql, $search);
...
?>
        ...
        <tr>
          ...
          <td class='c'><a href="javascript:b1n_orderBy('are_nome');">Nome</a></td>
          <td class='c'><a href="javascript:b1n_orderBy('are_ordem');">Ordem</a></td>
          <td class='c'><a href="javascript:b1n_orderBy('are_separador');">Separador</a></td>
          <td class='c'><a href="javascript:b1n_orderBy('are_ativo');">Ativo</a></td>
          <td class='c' colspan='4'><b>Fun&ccedil;&otilde;es</b></td>
        </tr>
<?
...
?>
          ...
          <td><?= b1n_inHtmlLimit($item['idi_nome']) ?></td>
          <td><?= b1n_inHtmlLimit($item['are_nome']) ?></td>
          <td><?= b1n_inHtml($item['are_ordem']) ?></td>
          <td><?= $item['are_separador'] == 1?'Sim':'Não' ?></td>
          <td><?= $item['are_ativo'] == 1?'Sim':'Não' ?></td>
<?
      // codigo ta vazio, nao eh area especial
      if(empty($item['are_codigo']))
      {
        // are_real_id ta vazio, eh uma area no idioma padrao
        if(empty($item['are_real_id']))
        {
          echo "<td class='c'>&nbsp;</td>";
          echo "<td class='c'>&nbsp;";
        ...
        // are_real_id tem coisa, entao eh uma area em outro idioma
        {
          echo "<td colspan='4' class='c'>&nbsp;";
          if(b1n_havePermission(b1n_FUNC_ACTIVATE_AREA))
          {
            echo "<a href='".b1n_URL."?page=".$page."&amp;action0=activate&amp;id=".$item['id']."'>Ativa/Desativa</a>";
          }
      ...
      {
        switch($item['are_codigo'])
        {
        case 'links':
          echo "<td class='c'>&nbsp;";
          if(b1n_havePermission(b1n_FUNC_LIST_LINK))
          {
            echo "<a href='".b1n_URL."?page=link&amp;id=".$item['id']."'>Links</a>";
          }
          echo "</td>";
          break;
        case 'noticias':
          ...
          {
            echo "<a href='".b1n_URL."?page=noticia&amp;id=".$item['id']."'>Not&iacute;cias</a>";
          }
          break;
        default:
          echo "<td class='c'>&nbsp;</td>";
