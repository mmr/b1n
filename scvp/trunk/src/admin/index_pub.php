<?
// $Id: index_pub.php,v 1.1.1.1 2004/01/25 15:18:50 mmr Exp $
...
<table class='topo'>
  <tr>
    ...
    <td class='topo_sys_nome'>
      Administra&ccedil;&atilde;o Publica&ccedil;&otilde;es (v<?= b1n_VERSION ?>)
    </td>
<?
// Current User
...
<table class='menu'>
  <tr>
    ...
    <td>|</td>
    <td>
      <a href='<?= b1n_URL . '?page=secao' ?>'>Se&ccedil;&atilde;o</a>
    </td>
    <td>|</td>
    <td>
      <a href='<?= b1n_URL . '?page=fasciculo' ?>'>Fasc&iacute;culo</a>
    </td>
    <td>|</td>
    <td>
...
require($inc);
?>
<div class='rodape'><a href='http://www.caboverde.com.br/' alt='_blank'><img src='../img/copy.gif' alt='CaboVerde' width='549px' height='14px' /></a></div>
