...
public class MouseAction {
    ...
    public MouseAction(String name, int x, int y, MouseButton button) {
        this(name, x, y, button, DEFAULT_DELAY);
    }

    public MouseAction(String name, int x, int y, MouseButton button, int delayAfter) {
        this(name, x, y, button, delayAfter, DEFAULT_X_VAR, DEFAULT_Y_VAR);
    }

    public MouseAction(String name, int x, int y, MouseButton button, int delayAfter, int xVar, int yVar) {
        this.name = name;
        this.x = x;
        this.y = y;
        this.button = button;
