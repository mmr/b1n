...
CREATE TABLE consumo (
	...
	cns_qtde	INT		NOT NULL	DEFAULT 1, /* quantidade do produto */
...
CREATE TABLE config (
    ...
    cfg_int		INT,
    cfg_txt		TEXT,
    cfg_money		NUMERIC(9,2)
);
INSERT INTO config (cfg_id,cfg_int) VALUES('session_timeout',120);
INSERT INTO config (cfg_id,cfg_money) VALUES('price_per_unit',2.5); /* preco por unidade em R$ */
INSERT INTO config (cfg_id,cfg_int) VALUES('time_unit',1800); /* unidade de tempo em seg */
INSERT INTO config (cfg_id,cfg_int) VALUES('tolerance',20);   /* tolerancia em % */
