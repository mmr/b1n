...
/*
 *
 * Esse arquivo (switch_usr.inc.php), é parte integrante dos 'eventos' (sn_acao),
...
{
	case "Cadastrar":
		$titulo  = cadastra_usr($valores, $campos_obrigatorios);
	...
	case "Editar":
		...
		$sn_acao = "Alterar";
		$itens   = "\n<a href='" . $PHP_SELF . "?sn_inc=" . $sn_inc . "'>Listar</a>";
		break;
	case "Alterar":
		$titulo = altera_usr($sn_id, $valores, $campos_obrigatorios);
