<?
/* $Id: sql_link.inc.php,v 1.1.1.1 2003/03/29 19:55:21 binary Exp $ */

/* Mon May 08 17:39:14 BRT 2000 - galmeida
 * isConnected()
 * connect()
 * isConnected()
 * private setError()
 ...
 * getDb()
 *
 * Tue Jun 20 18:04:33 BRT 2000 - lucas
 * ListTables()
 *
 * Wed Nov 15 14:30:41 BRST 2000 - galmeida
 * query -> squery;
 * mquery -> query;
 * 
 *
...
class sqlLink {
	...
	function connect()
	{
		...
		$this->link_sql = pg_connect("host=".$this->HOST." dbname=".$this->Db." user=".$this->USER." password=".$this->PASS);
