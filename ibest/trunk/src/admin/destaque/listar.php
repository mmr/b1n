...
?>
          <tr>
            <td bgcolor='#ffffff'>&nbsp;<?= in_html( strlen( $item[ 'des_nome' ] ) > MAXTEXTO ? substr( $item["des_nome"], 0, MAXTEXTO ) . "..." : $item[ 'des_nome' ] ) ?></td>
            <td bgcolor='#ffffff'><a href="<?= $_SERVER["SCRIPT_NAME"] ?>?suppagina=<?= $suppagina ?>&pagina=<?= $pagina ?>&subpagina=visualizar&des_id=<?= $item["des_id"] ?>">Visualizar</a></td>
          </tr>
